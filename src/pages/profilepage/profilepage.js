  ...
  useEffect(() => {
    axios
      .get('http://localhost:4000/routes/get_id_from_firebaseuid', {
        params: { firebase_id: 'i7JdvmMfvfe0A7dzLUCiOS4zngi1' },
      })
      .then(response => {
            ...
            <div>
              ...
              {revbool && revbool.payRange && (
                <ul>
                  <p>
                    {' '}
                    {revbool.payRange[0]} ~ {revbool.payRange[1]}
                  </p>
                </ul>
              )}
