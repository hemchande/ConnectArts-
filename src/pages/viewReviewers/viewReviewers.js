      ...
      <form className={classes.root} onSubmit={handleSubmit}>
        <Grid container direction="row" alignItems="center" spacing={2}>
          <Grid item>
            ...
            >
              <MenuItem value="Ballet" onClick={handleGenreChange}>
                Ballet
              </MenuItem>
              <MenuItem value="Jazz" onClick={handleGenreChange}>
                Jazz
              </MenuItem>
              <MenuItem value="Contemporary" onClick={handleGenreChange}>
                Contemporary
              </MenuItem>
              <MenuItem value="Lyrical" onClick={handleGenreChange}>
                Lyrical
              </MenuItem>
              <MenuItem value="Hip-hop" onClick={handleGenreChange}>
                Hip-Hop
              </MenuItem>
              <MenuItem value="Fusion" onClick={handleGenreChange}>
                Fusion
              </MenuItem>
              <MenuItem value="Tap" onClick={handleGenreChange}>
                Tap
              </MenuItem>
              <MenuItem value="Ballroom" onClick={handleGenreChange}>
                Ballroom
              </MenuItem>
              <MenuItem value="Modern" onClick={handleGenreChange}>
                Modern{' '}
              </MenuItem>
            </TextField>
          </Grid>
