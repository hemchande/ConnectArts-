...
function Card() {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:4000/routes/check_reviewer_status_for_reviewer', {
        params: {
          _id: id,
        },
        withCredentials: true,
    ...
    return (
      <>
        ...
        <button
          ...
          onClick={() => handleViewPerformancePostClick(post._id)}
        >
          View Performance
        </button>
        <div>
    ...
    <div className="card">
      <section className="main--container">
        ...
        <div>
          ...
          {currentPostsOpen && !curr_post && <strong> No Current Post</strong>}
      ...
      ;{currentReviewsOpen && !review && <strong> No Current Review</strong>}
